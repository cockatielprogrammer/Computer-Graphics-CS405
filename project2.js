...
function GetModelViewProjection(projectionMatrix, translationX, translationY, translationZ, rotationX, rotationY) {
  ...
  class MeshDrawer {
	constructor() {
	  ...
	  this.lightPos = [lightX, lightY, 0];
  
	  // Initialize ambient light intensity
	  this.ambient = 0.5; // You can set an initial value
	...
	draw(trans) {
	  ...
	  // Add normal buffer configuration
	  gl.bindBuffer(gl.ARRAY_BUFFER, this.normbuffer);
	  gl.enableVertexAttribArray(this.normalLoc);
	  gl.vertexAttribPointer(this.normalLoc, 3, gl.FLOAT, false, 0, 0);
	  ...
	  gl.uniform1i(this.enableLightLoc, this.isLightingEnabled ? 1 : 0);
  ...
  void main()
  {
	if (showTex && enableLighting) {
	  ...
	  vec3 ambientColor = ambient * color.rgb;
	  ...
	  // Combine ambient and diffuse light with texture color
	  vec3 finalColor = ambientColor + diffuse * texture2D(tex, v_texCoord).rgb;
  ...
  // You can now control the ambient light density and enable/disable lighting using your existing HTML controls.
